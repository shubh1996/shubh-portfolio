        ...
        <section className="max-w-4xl mx-auto px-4 py-20">
            ...
            <div className="relative border-l border-slate-800 ml-4">
                {content.experience.map((exp, index) => (
                    ...
                    >
                        {/* Timeline dot */}
                        <div className="absolute -left-[2.65rem] top-1.5 w-5 h-5 rounded-full bg-slate-900 border-2 border-slate-700 group-hover:border-violet-400 group-hover:scale-110 transition-all duration-300 flex items-center justify-center">
                            <div className="w-1.5 h-1.5 rounded-full bg-slate-600 group-hover:bg-violet-400 transition-colors duration-300" />
                        </div>

                        <span className="text-sm font-mono text-violet-400 mb-1 block">{exp.period}</span>
