                ...
                {content.certifications.map((cert, index) => {
                    ...
                    return (
                        <motion.div
                            ...
                            viewport={{ once: true }}
                            className={`relative group rounded-3xl p-6 border bg-white/[0.04] backdrop-blur-xl ${c.border} hover:border-opacity-60 transition-all duration-500 flex flex-col gap-4`}
                        >
                            {/* Hover glow */}
